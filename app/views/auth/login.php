...
<div class="page">
    ...
    <div class="card">
        ...
        <h1><?= Lang::get('Login') ?></h1>
        <p class="subtitle"><?= Lang::get('Sign in to your account') ?></p>
        ...
        <form method="post">
            ...
            <button class="btn-primary" type="submit"><?= Lang::get('Sign in') ?></button>
        </form>

        <p class="muted-link">
            <?= Lang::get("Don't have an account?") ?>
            <a href="<?= BASE_URL ?>?c=auth&a=register"><?= Lang::get('Sign up') ?></a>
        </p>

        <p class="muted-link">
            <a href="<?= BASE_URL ?>?c=auth&a=forgotPassword">Esqueci minha senha</a>
        </p>
